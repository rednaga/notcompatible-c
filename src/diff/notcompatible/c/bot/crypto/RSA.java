...
public class RSA {
	...
	/**
	 * Used on initial run - each bot will initialize a new public/private key
	 * and send it to the server for further comms
	 */
	public void genKey() {
		try {
	...
	public void saveClientPublic(File path) {
		try {
	        ...
	        DataOutputStream file = new DataOutputStream(new FileOutputStream(path.getAbsolutePath() + "/client.public"));
	...
	public void saveClientPrivate(File path) {
		try {
	        ...
	        DataOutputStream file = new DataOutputStream(new FileOutputStream(path.getAbsolutePath() + "/client.private"));
	        file.write(publicData);
	        file.flush();
	        file.close();
		} catch(Exception exception) {
