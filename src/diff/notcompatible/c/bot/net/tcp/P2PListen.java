...
public class P2PListen extends TCPListen {
    ...
    public void onAccept(SelectionKey key) throws IOException {
        ...
        if (owner.p2plist.getByIpAndPort(socketChannel.socket().getInetAddress().getHostAddress(), socketChannel
                        .socket().getPort()) == null) {// == null
            ...
            p2pLink.socketAddress = new InetSocketAddress(socketChannel.socket().getInetAddress().getHostAddress(),
